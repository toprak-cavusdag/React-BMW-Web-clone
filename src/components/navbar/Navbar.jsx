          ...
          {NavbarMenus.map((menu) => {
            return (
              ...
              >
                ...
                <div className='w-full absolute h-1 group-hover:bg-bmwBlue group-hover:translate-y-7'></div>
              </li>
            );
          })}
        </ul>
      ...
      <div className='flex'>
        <ul className='space-x-8 flex justify-center items-center'>
          <li className='text-white font-semibold group relative cursor-pointer'>
            <LocationOnIcon />
            <div className='w-full  absolute h-[3px] group-hover:bg-bmwBlue  group-hover:translate-y-7'></div>
          </li>
